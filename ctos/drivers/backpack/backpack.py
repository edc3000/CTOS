...
class BackpackSpot:
    ...
    def __init__(self, symbol, public_key, secret_key, host=None):
        self.symbol = symbol
        self._public_key = public_key
        self._secret_key = secret_key
        self.account_client = Account(public_key, secret_key, window=10000)
        self.public = Public()
    ...
    def get_orderbook(self, symbol=None, sz=5):
        try:
            success = self.public.get_depth(symbol)
            return success, None
    ...
    def get_trade(self, symbol):
       ...
       """
        ...
        try:
            success = float(self.public.get_history_trades(symbol, 1)[0]['price'])
            return success, None
        except Exception as e:
            return None, e
